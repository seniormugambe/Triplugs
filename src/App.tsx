...
import { TourismVenues } from "./components/TourismVenues";
...
const sampleEvents: Event[] = [
  {
    ...
    rating: 4.8,
    attendees: 24,
    organizer: "Uganda Mountain Guides",
    image:
      "https://images.unsplash.com/photo-1618833443374-91398b11b1d8?auto=format&fit=crop&w=400&q=80",
  ...
  {
    id: "2",
    title: "Ugandan Coffee Farm Experience",
    date: "2025-02-20",
    ...
    rating: 4.9,
    attendees: 16,
    organizer: "Arabica Coffee Tours Uganda",
    image:
  ...
  },
  {
    ...
    rating: 4.7,
    attendees: 12,
    organizer: "Uganda Wildlife Photography Academy",
    image:
...
const sampleTransport: Transport[] = [
  {
    id: "1",
    provider: "Rwenzori Mountain Shuttle",
    type: "Safari Vehicle",
    route: "Kampala → Rwenzori Mountains",
    price: 35,
    rating: 4.6,
  ...
  {
    id: "2",
    provider: "Coffee Farm Express",
    type: "Van",
    route: "Kampala → Mount Elgon Coffee Farms",
    price: 45,
    rating: 4.8,
  ...
  {
    id: "3",
    provider: "Uganda Safari Tours",
    type: "Game Drive Vehicle",
...
const sampleCulturalExperiences: CulturalExperience[] = [
  {
    ...
    description:
      "Immerse yourself in the rich traditions of the Buganda Kingdom, Uganda's largest traditional kingdom. Experience royal ceremonies, traditional music, and ancient customs.",
    duration: "2 Days",
    price: 180,
    maxParticipants: 12,
    difficulty: "Easy",
    ...
    communityBenefit:
      "70% of proceeds support local artisans and cultural preservation",
    ...
    localGuide: {
      ...
      background:
        "Royal historian and cultural expert with 20+ years experience",
  ...
  },
  {
    ...
    description:
      "Experience the nomadic lifestyle of the Karamojong people, known for their warrior traditions, cattle herding, and unique cultural practices.",
    duration: "3 Days",
    price: 220,
    maxParticipants: 8,
    difficulty: "Moderate",
    ...
    communityBenefit:
      "80% supports community development and education programs",
  ...
  },
  {
    ...
    description:
      "Learn about the indigenous Batwa people, former forest dwellers of Bwindi. Discover their traditional forest survival skills and cultural adaptation.",
    duration: "1 Day",
    price: 95,
    maxParticipants: 15,
    difficulty: "Easy",
...
const sampleEcoTourismSites: EcoTourismSite[] = [
  {
    ...
    description:
      "UNESCO World Heritage site home to nearly half of the world's mountain gorillas. Ancient rainforest with exceptional biodiversity and community-based conservation.",
    biodiversity: {
      species: 400,
      endemicSpecies: 10,
  ...
  },
  {
    ...
    description:
      "Uganda's most popular savanna park with diverse ecosystems, tree-climbing lions, and the famous Kazinga Channel boat safari.",
    biodiversity: {
      species: 618,
      endemicSpecies: 5,
  ...
  },
  {
    ...
    location: "Western Uganda",
    description:
      "Primate capital of the world with 13 primate species including chimpanzees. Tropical rainforest with exceptional primate research and conservation programs.",
    biodiversity: {
      species: 372,
      endemicSpecies: 8,
...
const sampleUgandanAgencies: TourismAgency[] = [
  {
    ...
    description:
      "Premier safari company specializing in gorilla trekking, wildlife safaris, and cultural experiences across Uganda. Family-owned business with 15+ years of experience.",
  ...
  },
  {
    ...
    description:
      "Adventure tourism specialists focusing on white water rafting, bungee jumping, and Nile River activities. Safety-certified with international standards.",
  ...
  },
  {
    ...
    description:
      "Specialized mountain climbing and trekking company for the Rwenzori Mountains (Mountains of the Moon). Expert guides and high-altitude experience.",
  ...
  },
  {
    ...
    description:
      "Authentic cultural experiences showcasing Ugandan traditions, history, and local communities. Supporting sustainable tourism and local development.",
    location: "Kampala, Uganda",
    established: 2015,
    rating: 4.6,
    reviewCount: 203,
  ...
  },
  {
    ...
    description:
      "Luxury safari experiences in Murchison Falls National Park. Specializing in boat safaris, game drives, and exclusive lodge accommodations.",
...
const sampleSafetyInfo: SafetyInfo[] = [
  {
    ...
    riskLevel: "Low",
    alerts: [
      "High altitude awareness for visitors",
...
const sampleVenues: Venue[] = [
  ...
  },
  {
    ...
    description:
      "Beautiful outdoor pavilion perfect for festivals and large gatherings",
  },
  {
    id: "3",
...
const generateAIRecommendations = (
  ...
  const recommendations = [
    `Based on your interest in ${userPreferences.interests.join(
      " and "
    )}, I recommend the Mountain Hiking Adventure`,
  ...
  return data.filter((item) =>
    keywords.some(
      (keyword) =>
        ...
        item.specialties?.some((spec: string) =>
...
const aiPersonalizedSorting = (items: any[], userPreferences: any) => {
  return items.sort((a, b) => {
    ...
    // Interest matching
    if (userPreferences.interests.includes(a.category?.toLowerCase()))
      scoreA += 10;
    if (userPreferences.interests.includes(b.category?.toLowerCase()))
      scoreB += 10;
...
const notifications = [
  {
    id: 1,
    type: "ai",
    message: "AI found 3 perfect matches for your interests!",
    time: "1 min ago",
    unread: true,
  },
  {
    id: 2,
    type: "booking",
    message: "Smart booking: Mountain Hiking + Transport bundle available",
    time: "5 min ago",
    unread: true,
  },
  {
    id: 3,
    type: "ai",
    message: "AI Tip: Best time to visit Bwindi is 2-4 PM today",
    time: "15 min ago",
    unread: true,
  },
  {
    id: 4,
    type: "weather",
    message: "AI Weather Alert: Perfect conditions for gorilla trekking!",
    time: "1 hour ago",
    unread: false,
  },
  {
    id: 5,
    type: "ai",
    message: "Price drop detected: Cultural tour now 20% off",
    time: "2 hours ago",
    unread: false,
  },
];
...
function App() {
  const [activeTab, setActiveTab] = useState<
    StakeholderType | "home" | "explore" | "venues"
  >("home");
  const [exploreSection, setExploreSection] = useState<
    "blogs" | "forum" | "reviews" | "influencers"
  >("blogs");
  ...
  const [bookingStep, setBookingStep] = useState<
    "event" | "transport" | "equipment" | "summary"
  >("event");
  ...
  const [aiChatHistory, setAiChatHistory] = useState<
    { role: "user" | "ai"; message: string; timestamp: Date }[]
  >([]);
  ...
  const stakeholderTabs = [
    {
      id: "seeker" as StakeholderType,
      label: "Event Seekers",
      icon: Calendar,
      color: "bg-forest-600",
    },
    {
      id: "organizer" as StakeholderType,
      label: "Event Organizers",
      icon: Users,
      color: "bg-earth-600",
    },
    {
      id: "transport" as StakeholderType,
      label: "Transport Providers",
      icon: Truck,
      color: "bg-sunshine-600",
    },
    {
      id: "equipment" as StakeholderType,
  ...
  const additionalServices = [
    {
      id: "ai-guide" as ServiceType,
      label: "AI-Powered Guides",
      icon: Zap,
      color: "bg-forest-600",
      description: "Smart AI companions for your Uganda journey",
    },
    {
      id: "cultural" as ServiceType,
      label: "Cultural Experiences",
      icon: Users,
      color: "bg-earth-600",
      description: "Authentic tribal and cultural immersions",
    },
    {
      id: "eco-tourism" as ServiceType,
      label: "Eco-Tourism",
      icon: Mountain,
      color: "bg-sunshine-600",
      description: "Sustainable wildlife and nature experiences",
    },
    {
      id: "agencies" as ServiceType,
      label: "Tourism Agencies",
      icon: Award,
      color: "bg-stone-600",
      description: "Verified Ugandan tourism companies",
    },
    {
      id: "payments" as ServiceType,
      label: "Payments & Rates",
      icon: CreditCard,
      color: "bg-earth-600",
      description: "Payment processing rates and methods",
    },
    {
      id: "weather" as ServiceType,
      label: "Weather Info",
      icon: Cloud,
      color: "bg-sunshine-600",
    ...
    },
    {
      ...
      icon: Route,
      color: "bg-stone-600",
      description: "Curated travel plans and itineraries",
    },
    {
      id: "safety" as ServiceType,
    ...
    {
      id: "misc" as ServiceType,
      label: "Miscellaneous",
      icon: MoreHorizontal,
      color: "bg-forest-600",
      description: "Additional travel services and tools",
    },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-nature-50 via-triplugs-50 to-forest-50 dark:from-stone-900 dark:via-stone-800 dark:to-stone-900 triplugs-pattern transition-colors duration-300">
      {/* Header */}
      <header className="bg-white/95 dark:bg-stone-900/95 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-triplugs-200 dark:border-stone-700 transition-colors duration-300">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden lg:flex items-center space-x-2">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all ${
                  activeTab === "shop"
                    ? "bg-gradient-to-r from-triplugs-500 to-forest-500 text-white shadow-lg"
                    : "text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-dark-200"
                }`}
              >
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden lg:flex items-center space-x-2 bg-white/80 dark:bg-dark-200/80 backdrop-blur-sm px-3 py-2 rounded-full border border-earth-200 dark:border-dark-300">
                ...
                <span className="text-sm font-medium text-stone-700 dark:text-dark-800">
                  {weatherData.temp}°F
                </span>
                <span className="text-xs text-stone-500 dark:text-dark-700">
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-xl border border-stone-200 z-50">
                    ...
                    <div className="max-h-64 overflow-y-auto">
                      {notifications.map((notification) => (
                        <div
                          key={notification.id}
                          className={`p-4 border-b border-stone-100 hover:bg-stone-50 ${
                            notification.unread ? "bg-forest-50/30" : ""
                          }`}
                        >
                          <div className="flex items-start space-x-3">
                            ...
                            >
                              ...
                              {notification.type === "review" && (
                                <Star className="h-4 w-4 text-sunshine-600" />
                              )}
                              {notification.type === "payment" && (
                                <CreditCard className="h-4 w-4 text-earth-600" />
                              )}
                              {notification.type === "weather" && (
                                <Cloud className="h-4 w-4 text-sunshine-600" />
                              )}
                            </div>
              ...
              <div className="flex items-center space-x-3 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-earth-200">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-sm font-medium text-sunshine-600">
                    {currentUser.points}
                  </span>
                </div>
              </div>
            ...
            <div className="lg:hidden py-4 border-t border-earth-200 dark:border-dark-300">
              <div className="space-y-2">
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${
                    activeTab === "shop"
                      ? "bg-gradient-to-r from-triplugs-500 to-forest-500 text-white"
                      : "text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-dark-200"
                  }`}
                >
                ...
                >
                  <MapPin className="h-5 w-5" />
                  <span className="font-medium">Tourism Map</span>
                </button>
                <button
                  onClick={() => {
                    setActiveTab("organizer");
      ...
      {activeTab !== "home" && (
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
              ...
              <div>
                <div className="text-center mb-12">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <h3 className="text-3xl font-bold text-stone-900">
                      AI-Powered Uganda Guides
                    </h3>
                  </div>
                  <p className="text-stone-600 max-w-3xl mx-auto">
                    Meet your intelligent travel companions! Our AI guides
                    provide real-time assistance, cultural insights, and
                    personalized recommendations throughout your Uganda
                    adventure.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                  {sampleAIGuides.map((guide) => (
                    <div
                      key={guide.id}
                      className="bg-white rounded-2xl nature-card p-6 text-center"
                    >
                      {/* AI Avatar */}
                      ...
                      {/* Languages */}
                      <div className="mb-4">
                        <h5 className="font-semibold text-stone-900 mb-2">
                          Languages
                        </h5>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="space-y-2">
                          {Object.entries(guide.capabilities).map(
                            ([capability, enabled]) => (
                              <div
                                key={capability}
                ...
                <div className="bg-gradient-to-r from-forest-50 to-sunshine-50 rounded-2xl p-8 mb-12">
                  <h4 className="text-2xl font-bold text-stone-900 text-center mb-8">
                    AI Guide Features
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Ask questions and get instant responses in your
                        preferred language
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Point your camera at animals, plants, or landmarks for
                        instant information
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Get personalized routes and recommendations based on
                        your interests
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        24/7 emergency assistance and safety monitoring
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl nature-card p-6">
                  ...
                  <div className="bg-stone-50 rounded-lg p-4 h-64 overflow-y-auto mb-4">
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        <div className="w-8 h-8 bg-forest-600 rounded-full flex items-center justify-center text-white text-sm">
                          🤖
                        </div>
                        <div className="bg-white p-3 rounded-lg shadow-sm">
                          <p className="text-sm">
                            Hello! I'm Kato AI, your Uganda wildlife guide. What
                      ...
                      <div className="flex items-start space-x-3 justify-end">
                        <div className="bg-forest-100 p-3 rounded-lg">
                          <p className="text-sm">
                            Tell me about mountain gorillas in Bwindi
                          </p>
                        </div>
                        <div className="w-8 h-8 bg-stone-400 rounded-full flex items-center justify-center text-white text-sm">
                          👤
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="bg-white p-3 rounded-lg shadow-sm">
                          <p className="text-sm">
                            Bwindi is home to nearly half of the world's
                            mountain gorillas! There are about 459 gorillas in
                            19 habituated groups. The best time to visit is
                            during dry seasons (June-August, December-February).
                            Would you like me to help you plan a gorilla
                            trekking experience?
                          </p>
                        </div>
                      </div>
            ...
            {activeService === "cultural" && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-3xl mx-auto">
                    Immerse yourself in Uganda's rich cultural heritage through
                    authentic experiences with local communities. Support
                    sustainable tourism while learning about diverse tribal
                    traditions.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                  {sampleCulturalExperiences.map((experience) => (
                    <div
                      key={experience.id}
                      className="bg-white rounded-2xl nature-card overflow-hidden"
                    >
                      <div className="relative">
                        <img
                        ...
                        <div className="absolute top-4 right-4 flex flex-col gap-2">
                          <div
                            className={`px-3 py-1 rounded-full text-xs font-medium ${
                              experience.authenticity === "Traditional"
                        ...
                        <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-stone-900">
                              Sustainability: {experience.sustainabilityScore}%
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            ...
                            <p className="text-earth-600 font-medium">
                              {experience.tribe} • {experience.region}
                            </p>
                          </div>
                            ...
                            <div
                              className={`text-xs px-2 py-1 rounded ${
                                experience.difficulty === "Easy"
                                  ...
                                  ? "bg-sunshine-100 text-sunshine-800"
                        ...
                        <div className="mb-4">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {experience.culturalElements.map(
                              (element, index) => (
                                <span
                                  key={index}
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <p className="font-medium text-stone-900">
                                {experience.localGuide.name}
                              </p>
                              <p className="text-xs text-stone-600 mb-1">
                                {experience.localGuide.background}
                              </p>
                              <div className="flex flex-wrap gap-1">
                                {experience.localGuide.languages.map(
                                  (lang, index) => (
                                    <span
                                      key={index}
                ...
                <div className="bg-gradient-to-r from-earth-50 to-forest-50 rounded-2xl p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Direct economic benefits to local communities through
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Supporting the preservation of traditional practices and
                        knowledge
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Meaningful cultural exchange between visitors and local
                        communities
                      </p>
                    </div>
                  </div>
            ...
            {activeService === "eco-tourism" && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-3xl mx-auto">
                    Explore Uganda's incredible biodiversity while supporting
                    conservation efforts and local communities. Our eco-tourism
                    sites prioritize sustainability and environmental
                    protection.
                  </p>
                </div>
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="absolute top-4 right-4 flex flex-col gap-2">
                          <div
                            className={`px-3 py-1 rounded-full text-xs font-medium ${
                              site.conservationStatus === "Excellent"
                                ? "bg-forest-500 text-white"
                                : site.conservationStatus === "Good"
                                ? "bg-sunshine-500 text-white"
                                : "bg-earth-500 text-white"
                            }`}
                          >
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            ...
                            <p className="text-sunshine-600 font-medium">
                        ...
                        <div className="mb-4 bg-forest-50 p-3 rounded-lg">
                          ...
                          <div className="grid grid-cols-3 gap-2 text-center">
                            ...
                            <div>
                              <div className="text-lg font-bold text-earth-600">
                                {site.biodiversity.endemicSpecies}
                              </div>
                              <div className="text-xs text-stone-600">
                                Endemic
                              </div>
                            ...
                            <div>
                              <div className="text-lg font-bold text-sunshine-600">
                                {site.biodiversity.threatenedSpecies}
                              </div>
                              <div className="text-xs text-stone-600">
                                Threatened
                              </div>
                        ...
                        <div className="mb-4 bg-sunshine-50 p-3 rounded-lg">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-lg font-bold text-sunshine-600">
                              {site.carbonOffset} kg CO₂
                            </span>
                          </div>
                          <p className="text-xs text-stone-600 mt-1">
                            Per visitor contribution to carbon sequestration
                          </p>
                        </div>
                        ...
                        <div className="mb-4 bg-earth-50 p-3 rounded-lg">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            <div>
                              <div className="font-bold text-earth-600">
                                {site.communityImpact.jobsCreated}
                              </div>
                              <div className="text-xs text-stone-600">
                                Jobs Created
                              </div>
                            ...
                            <div>
                              <div className="font-bold text-earth-600">
                                {site.communityImpact.revenueToLocal}%
                              </div>
                              <div className="text-xs text-stone-600">
                                Local Revenue
                              </div>
                ...
                <div className="bg-gradient-to-r from-sunshine-50 to-forest-50 rounded-2xl p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Your visit directly funds wildlife protection and
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Supporting local communities through sustainable job
                        creation
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Every visit contributes to carbon sequestration and
                        climate action
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Contributing to scientific research and species
                        monitoring programs
                      </p>
                    </div>
                  </div>
              ...
              <div>
                <div className="text-center mb-12">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <h3 className="text-3xl font-bold text-stone-900">
                      Verified Ugandan Tourism Agencies
                    </h3>
                  </div>
                  <p className="text-stone-600 max-w-3xl mx-auto">
                    Connect with legitimate, licensed tourism companies in
                    Uganda. All agencies are verified by the Uganda Tourism
                    Board and offer comprehensive insurance coverage for
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute top-4 right-4 flex flex-col gap-2">
                          ...
                          <div
                            className={`px-3 py-1 rounded-full text-xs font-medium ${
                              agency.priceRange === "Budget"
                                ? "bg-forest-100 text-forest-800"
                                : agency.priceRange === "Mid-Range"
                                ? "bg-sunshine-100 text-sunshine-800"
                                : "bg-earth-100 text-earth-800"
                            }`}
                          >
                      ...
                      <div className="p-6">
                        ...
                        {/* Popular Packages */}
                        <div className="mb-6">
                          <h5 className="font-semibold text-stone-900 mb-3">
                            Popular Packages
                          </h5>
                          <div className="space-y-3">
                            {agency.packages.slice(0, 2).map((pkg, index) => (
                              ...
                              >
                                <div className="flex justify-between items-start mb-2">
                                  <h6 className="font-medium text-stone-900">
                                    {pkg.name}
                                  </h6>
                                  <div className="text-right">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                            ...
                            {agency.contactInfo.whatsapp && (
                              <div className="flex items-center">
                                ...
                                <span className="text-stone-600">
                                  WhatsApp: {agency.contactInfo.whatsapp}
                                </span>
                              </div>
                            )}
                          </div>
                ...
                <div className="mt-12 bg-forest-50 rounded-2xl p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        All agencies are licensed by Uganda Tourism Board with
                        comprehensive insurance coverage.
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Regular quality checks and customer feedback monitoring
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-stone-600 text-sm">
                        Direct communication with agencies and emergency support
                        throughout your Uganda experience.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-2xl mx-auto">
                    Transparent pricing and secure payment options for all
                    tourism services.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {samplePaymentRates.map((rate) => (
                    <div
                      key={rate.id}
                      className="bg-white rounded-xl nature-card p-6"
                    >
                      <h5 className="text-lg font-semibold text-stone-900 mb-4">
                        {rate.service}
                      </h5>
                      <div className="space-y-3">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white rounded-xl nature-card p-6">
                    <h5 className="text-lg font-semibold text-stone-900 mb-4">
                      Current Weather - {sampleWeatherData.location}
                    </h5>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="text-3xl font-bold text-stone-900">
                            {sampleWeatherData.current.temperature}°F
                          </div>
                          <div className="text-stone-600">
                            {sampleWeatherData.current.condition}
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center">
                        ...
                        <span className="text-stone-600">
                          {sampleWeatherData.current.windSpeed} mph
                        </span>
                      </div>
                      <div className="flex items-center">
                        <Thermometer className="h-5 w-5 text-stone-500 mr-2" />
                        <span className="text-stone-600">
                          {sampleWeatherData.current.humidity}% humidity
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      {sampleWeatherData.forecast.map((day, index) => (
                        ...
                        >
                          <div className="flex items-center">
                            {day.condition === "Sunny" && (
                              <Sun className="h-5 w-5 text-sunshine-500 mr-3" />
                            )}
                            {day.condition === "Cloudy" && (
                              <Cloud className="h-5 w-5 text-stone-500 mr-3" />
                            )}
                            {day.condition === "Rain" && (
                              <CloudRain className="h-5 w-5 text-stone-600 mr-3" />
                            )}
                            {day.condition === "Partly Cloudy" && (
                              <Sun className="h-5 w-5 text-sunshine-400 mr-3" />
                            )}
                            <div>
            ...
            {activeService === "planning" && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-2xl mx-auto">
                    Curated travel plans and itineraries for unforgettable
                    experiences.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {activeService === "safety" && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-2xl mx-auto">
                    Stay informed and safe with real-time security updates and
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {sampleSafetyInfo.map((info) => (
                    ...
                    >
                      ...
                      {/* Emergency Contacts */}
                      <div className="mb-4">
                        <h6 className="font-medium text-stone-900 mb-2">
                          Emergency Contacts
                        </h6>
                        <div className="space-y-1 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {info.emergencyContacts.medical}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-stone-600">
                            ...
                            <span className="font-medium">
                              {info.emergencyContacts.tourist}
                            </span>
                          </div>
                        </div>
                      </div>
            ...
            {activeService === "misc" && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-2xl mx-auto">
                    Additional tools and services to enhance your travel
                    experience.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="bg-white rounded-xl nature-card p-6 text-center">
                    ...
                    <h5 className="text-lg font-semibold text-stone-900 mb-2">
                      Currency Exchange
                    </h5>
                    <p className="text-stone-600 text-sm mb-4">
                  ...
                  <div className="bg-white rounded-xl nature-card p-6 text-center">
                    ...
                    <p className="text-stone-600 text-sm mb-4">
                      Comprehensive coverage for your trips
                    </p>
                  ...
                  <div className="bg-white rounded-xl nature-card p-6 text-center">
                    ...
                    <p className="text-stone-600 text-sm mb-4">
                      Real-time translation and language guides
                    </p>
            ...
            {!activeService && activeTab === "seeker" && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-2xl mx-auto">
                    Find the perfect experience for your next adventure. From
                    outdoor activities to cultural events.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {sampleEvents.map((event) => (
                    <div
                      key={event.id}
                      className="bg-white rounded-2xl nature-card overflow-hidden group relative"
                    >
                      <div className="relative">
                        <img
                          src={event.image}
                        ...
                        <div className="absolute top-4 left-4 flex flex-col space-y-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          <button
                            onClick={() =>
                              toggleFavorite(event.id, favorites, setFavorites)
                            }
                      ...
                      <div className="p-6">
                        ...
                        <div className="space-y-2 mb-4">
                          ...
                          <div className="flex items-center text-sm text-stone-600">
                            ...
                            {new Date(event.date).toLocaleDateString()} • 2:00
                            PM
                          </div>
                          <div className="flex items-center text-sm text-stone-600">
                            <Users className="h-4 w-4 mr-2 text-earth-500" />
                            {event.attendees} going •{" "}
                            {Math.floor(Math.random() * 20) + 5} spots left
                          </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-4 mb-4 text-xs text-stone-500">
                          <div className="flex items-center space-x-1">
                            ...
                            <span>
                              {Math.floor(Math.random() * 100) + 50} likes
                            </span>
                          </div>
                          <div className="flex items-center space-x-1">
                            <MessageCircle className="h-3 w-3" />
                            <span>
                              {Math.floor(Math.random() * 20) + 5} comments
                            </span>
                          </div>
                          <div className="flex items-center space-x-1">
            ...
            {!activeService && activeTab === "organizer" && (
              <div>
                <div className="text-center mb-8">
                  ...
                  <p className="text-stone-600 max-w-2xl mx-auto">
                    Manage your events, venues, and bookings with our
                ...
                {organizerView === "dashboard" && (
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="bg-white rounded-2xl nature-card p-8">
                      <h4 className="text-xl font-semibold text-stone-900 mb-6">
                        Event Statistics
                      </h4>
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-2xl font-bold text-earth-600">
                            156
                          </span>
                        </div>
                        <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-2xl font-bold text-sunshine-600">
                            4.8
                          </span>
                        </div>
                      </div>
                      ...
                      {sampleVenues
                        .filter(
                          (venue) =>
                            ...
                            venue.category === selectedVenueCategory
                        )
                        .map((venue) => (
                          <div
                            key={venue.id}
                ...
                {organizerView === "create" && (
                  <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-2xl nature-card p-8">
                      <h4 className="text-2xl font-semibold text-stone-900 mb-8">
                        Create New Event
                      </h4>
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {!activeService && activeTab === "transport" && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-2xl mx-auto">
                    Find reliable transportation options or offer your transport
                    services to event attendees.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {sampleTransport.map((transport) => (
                    <div
                      key={transport.id}
                      className="bg-white rounded-2xl nature-card p-6"
                    >
                      <div className="flex items-center justify-between mb-4">
            ...
            {!activeService && activeTab === "equipment" && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-stone-600 max-w-2xl mx-auto">
                    Rent high-quality equipment for your adventures or list your
                    equipment for rental income.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {sampleEquipment.map((equipment) => (
                    <div
                      key={equipment.id}
                      className="bg-white rounded-2xl nature-card overflow-hidden group"
                    >
                      <div className="relative">
                        <img
                          src={equipment.image}
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-stone-600 text-sm mb-4">
                          Provided by {equipment.provider}
                        </p>
            ...
            {!activeService && activeTab === "shop" && <Shop />}

            {!activeService && activeTab === "explore" && (
              <div>
                <div className="text-center mb-8">
                  ...
                  <p className="text-stone-600 max-w-3xl mx-auto">
                    Connect with fellow travelers, share experiences, and
                    discover authentic stories from Uganda's tourism community
                  </p>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-8">
                  <button
                    onClick={() => setExploreSection("blogs")}
                    className={`px-6 py-3 rounded-lg font-medium transition-all ${
                      exploreSection === "blogs"
                        ? "bg-sunshine-500 text-white shadow-lg"
                  ...
                  <button
                    onClick={() => setExploreSection("forum")}
                    className={`px-6 py-3 rounded-lg font-medium transition-all ${
                      exploreSection === "forum"
                        ? "bg-sunshine-500 text-white shadow-lg"
                        : "bg-white text-stone-700 hover:bg-stone-50 border border-stone-200"
                    }`}
                  >
                  ...
                  <button
                    onClick={() => setExploreSection("reviews")}
                    className={`px-6 py-3 rounded-lg font-medium transition-all ${
                      exploreSection === "reviews"
                        ? "bg-sunshine-500 text-white shadow-lg"
                        : "bg-white text-stone-700 hover:bg-stone-50 border border-stone-200"
                    }`}
                  >
                  ...
                  <button
                    onClick={() => setExploreSection("influencers")}
                    className={`px-6 py-3 rounded-lg font-medium transition-all ${
                      exploreSection === "influencers"
                        ? "bg-sunshine-500 text-white shadow-lg"
                        : "bg-white text-stone-700 hover:bg-stone-50 border border-stone-200"
                    }`}
                  >
                ...
                {/* Community Content */}
                {exploreSection === "blogs" && <TravelBlogs />}
                {exploreSection === "forum" && <CommunityForum />}
                {exploreSection === "reviews" && <ReviewSystem />}
                {exploreSection === "influencers" && (
      ...
      {/* Tourism Venues Section */}
      {!activeService && activeTab === "venues" && (
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <TourismVenues />
          </div>
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-center mb-8">
                <div className="flex items-center space-x-4">
                  {["event", "transport", "equipment", "summary"].map(
                    (step, index) => (
                      <div key={step} className="flex items-center">
                        ...
                        {index < 3 && (
                          <div className="w-8 h-0.5 bg-stone-200 mx-4"></div>
                        )}
                      </div>
                    )
                  )}
              ...
              {bookingStep === "transport" && (
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    {sampleTransport
                      .filter((transport) =>
                        selectedEvent.recommendedTransport?.includes(
                          transport.id
                        )
                      )
                      .map((transport) => (
              ...
              {bookingStep === "equipment" && (
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    {sampleEquipment
                      .filter((equipment) =>
                        selectedEvent.recommendedEquipment?.includes(
                          equipment.id
                        )
                      )
                      .map((equipment) => (
          ...
          <div className="bg-gradient-to-r from-forest-500 to-forest-600 rounded-2xl shadow-2xl p-4 max-w-sm">
            ...
            <div className="bg-white/10 rounded-lg p-3 mb-3">
              <p className="text-white text-sm">
                🤖 I'm analyzing your preferences... Based on your interests in{" "}
                {aiPersonalization.interests.join(" & ")}, I recommend exploring
                our {activeService || activeTab} section!
              </p>
            </div>
      ...
      <footer className="bg-stone-900 text-white py-12 px-4 sm:px-6 lg:px-8 mt-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-stone-400">
                Your AI-powered gateway to Uganda's incredible tourism
                experiences. Discover, plan, and book with intelligent
                recommendations.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-stone-800 mt-8 pt-8 text-center text-stone-400">
            <p>
              &copy; 2025 TourismHub. All rights reserved. Powered by AI for
              Uganda Tourism.
            </p>
          </div>
        </div>
